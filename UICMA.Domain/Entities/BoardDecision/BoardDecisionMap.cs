...
namespace UICMA.Domain.Entities.BoardDecisionMap
{
  public  class BoardDecisionMap
    {
        public BoardDecisionMap(EntityTypeBuilder<BoardDecision> builder)
        {
            builder.ToTable("BOARD_DECISION_TBL");
            ...
            builder.HasOne<Claim>(s => s.claim).WithOne(x => x.boardDecision).HasForeignKey<BoardDecision>(t => t.ClaimId);
        }
    }
}
