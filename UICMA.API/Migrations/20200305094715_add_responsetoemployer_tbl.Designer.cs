...
namespace UICMA.API.Migrations
{
    ...
    [Migration("20200305094715_add_responsetoemployer_tbl")]
    partial class add_responsetoemployer_tbl
    {
            ...
            modelBuilder.Entity("UICMA.Domain.Entities.Claim_Determination.ClaimDetermination", b =>
                {
                    ...
                    b.Property<DateTime?>("ModifiedOn")
                        ...
                        .HasDefaultValue(new DateTime(2020, 3, 5, 15, 17, 14, 783, DateTimeKind.Local).AddTicks(4540));
            ...
            modelBuilder.Entity("UICMA.Domain.Entities.Claim_Interview.ClaimInterview", b =>
                {
                    ...
                    b.Property<DateTime?>("ModifiedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("MODIFIED_ON")
                        .HasDefaultValue(new DateTime(2020, 3, 5, 15, 17, 14, 774, DateTimeKind.Local).AddTicks(813));
            ...
            modelBuilder.Entity("UICMA.Domain.Entities.Claim_Response.ClaimResponse", b =>
                {
                    ...
                    b.Property<DateTime?>("ModifiedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("MODIFIED_ON")
                        .HasDefaultValue(new DateTime(2020, 3, 5, 15, 17, 14, 764, DateTimeKind.Local).AddTicks(2442));
            ...
            modelBuilder.Entity("UICMA.Domain.Entities.MD_Document.MDDocument", b =>
                {
                    ...
                    b.Property<DateTime?>("ModifiedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("MODIFIED_ON")
                        .HasDefaultValue(new DateTime(2020, 3, 5, 15, 17, 14, 756, DateTimeKind.Local).AddTicks(2859));
            ...
            modelBuilder.Entity("UICMA.Domain.Entities.MD_Form.MDForm", b =>
                {
                    ...
                    b.Property<DateTime?>("ModifiedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("MODIFIED_ON")
                        .HasDefaultValue(new DateTime(2020, 3, 5, 15, 17, 14, 753, DateTimeKind.Local).AddTicks(3475));
            ...
            modelBuilder.Entity("UICMA.Domain.Entities.New_Claim.Claim", b =>
                {
                    ...
                    b.Property<DateTime?>("ModifiedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("MODIFIED_ON")
                        .HasDefaultValue(new DateTime(2020, 3, 5, 15, 17, 14, 749, DateTimeKind.Local).AddTicks(8604));
            ...
            modelBuilder.Entity("UICMA.Domain.Entities.Questions.Question", b =>
                {
                    ...
                    b.Property<DateTime?>("ModifiedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("MODIFIED_ON")
                        .HasDefaultValue(new DateTime(2020, 3, 5, 15, 17, 14, 778, DateTimeKind.Local).AddTicks(1511));
            ...
            modelBuilder.Entity("UICMA.Domain.Entities.Response_to_Employer.ResponseToEmployer", b =>
                {
                    ...
                    b.Property<DateTime?>("ModifiedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("MODIFIED_ON")
                        .HasDefaultValue(new DateTime(2020, 3, 5, 15, 17, 14, 790, DateTimeKind.Local).AddTicks(3960));
            ...
            modelBuilder.Entity("UICMA.Domain.Entities.Schedule", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2020, 3, 5, 15, 17, 14, 737, DateTimeKind.Local).AddTicks(4888));
                    ...
                    b.Property<DateTime>("ModifiedOn")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2020, 3, 5, 15, 17, 14, 738, DateTimeKind.Local).AddTicks(3123));
